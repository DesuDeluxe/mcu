...
//values
#define leftstop 200            // Left  boundary 100
#define rightstop 3300           // Right  boundary
#define deadzone 139.5    //dc motor dead zone - depend on pwm frequency and voltage 140.5
#define err 60   // 55
#define respeed 175  //#define respeed 190
...
myPID.SetOutputLimits(-(255-deadzone-err),(255-deadzone-err));
...
Serial.print("\r\n");
  PiDoutput=0.000001;
  set_setpoint(pointt);
while(!(PiDoutput==0 || PiDoutput==2.00)){
  Input = encoder1Pos;
  go();
