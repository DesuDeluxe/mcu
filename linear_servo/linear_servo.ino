...
#define leftstop 100            // Left  boundary
#define rightstop 3450           // Right  boundary
#define deadzone 139.5 //dc motor dead zone - depend on pwm frequency and voltage135.5 139.5
#define err 70   //limit pid max output60
#define respeed 180  //#define respeed 180

int newpos = 0;
int* a;///////////dynamic array TODO:
...
if (Serial.available() > 0) { //getting commands from pc
    ...
    switch(cmd) {
      ...
      case 'm': newpos+=50; set_setpoint(newpos); go(); break;
