...
char serialChar=0;
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++DC
int x=0,y=0;//indicator values for linear movement
...
void setup() {
  //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++DC
  TCCR2B = TCCR2B & 0b11111000 | B00000001;   // set timer  divisor to  1 for PWM frequency of 31372.55 hz 
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++DC
...
if (PiDoutput>0){
  if (encoder1Pos<=leftstop){
    ...
    if (encoder1Pos>=rightstop){
      move_dc_left(190);//130
     // dc_stop();
