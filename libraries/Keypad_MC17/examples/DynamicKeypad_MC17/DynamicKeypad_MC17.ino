...
Keypad_MC17 numpad( makeKeymap(numberKeys), rowPins, colPins, sizeof(rowPins), sizeof(colPins), I2CADDR );
Keypad_MC17 ltrpad( makeKeymap(alphaKeys), rowPins, colPins, sizeof(rowPins), sizeof(colPins), I2CADDR );
Keypad_MC17 keypad = numpad;
