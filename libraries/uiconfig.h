...
void uiInitKeys() {
  ...
  UI_KEYS_INIT_BUTTON_LOW(32); // push button, connects gnd to pin
  UI_KEYS_INIT_BUTTON_LOW(45);
...
void uiCheckKeys(uint16_t &action) {
 ...
 UI_KEYS_BUTTON_LOW(45,UI_ACTION_OK); // push button, connects gnd to pin
 UI_KEYS_BUTTON_LOW(47,UI_ACTION_NEXT); // push button, connects gnd to pin
 UI_KEYS_BUTTON_LOW(32,UI_ACTION_PREVIOUS); // push button, connects gnd to pin
